...
double Simulation::pressureSolve(int xLocation, int yLocation, int i)
{
	...
	//Periodic
	if (xLocation == nx-1)
		pijp1n = solvedPrePresData[subCounter-1][0+yLocation*ny];
	else
		pijp1n = solvedPrePresData[subCounter-1][xLocation+1+yLocation*ny];

	if (xLocation == 0)
		pijm1n = solvedPrePresData[subCounter-1][nx-1+yLocation*ny];
	else
...
double Simulation::yMomentumSolve(int xLocation, int yLocation)
{
	...
	if (xLocation == nx-1)
	{
		pijp1n = solvedPrePresData[nit-1][0+yLocation*ny];
		uijp1n = solvedVelData[counter-1][0+yLocation*ny].u;
		vijp1n = solvedVelData[counter-1][0+yLocation*ny].v;
	}
	else
	...
	if (xLocation == 0)
	{
		pijm1n = solvedPrePresData[nit-1][nx-1+yLocation*ny];
		uijm1n = solvedVelData[counter-1][nx-1+yLocation*ny].u;
		vijm1n = solvedVelData[counter-1][nx-1+yLocation*ny].v;
	}
	else
